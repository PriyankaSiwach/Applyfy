...
const bullets = [
  "Full analysis in under 2 minutes",
  "Resume rewritten to match any job posting",
  "Salary negotiation script included",
];
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-[360px]">
          ...
          >
            Join hundreds of job seekers who stopped guessing and started getting hired.
          </p>
        ...
        >
          © {new Date().getFullYear()} Applyfy · Free to start. No credit card required.
        </div>
      </div>
